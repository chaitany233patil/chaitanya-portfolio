      ...
      <div className="flex">
        <div className="max-w-3xl mx-auto w-full px-6">
          ...
          <div className="flex flex-col items-center mt-10">
            <div className="text-4xl font-serif font-bold dark:text-accentAqua">
              Projects
            </div>
            <div className="text-neutral-400 text-md font-serif dark:text-textMain">
              Project&apos;s I Crafted
            </div>
          </div>

          {/* Projects */}
          <div className="text-2xl text-neutral-800 mt-20 mb-8 dark:text-textMain">
            Top Projects
          </div>
